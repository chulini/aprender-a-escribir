...
#pragma warning restore 219
	...
	public static bool HasFieldAndNotNull(JSONObject k, string fieldName){
		return (k != null && k.HasField(fieldName) && k.GetField(fieldName) != null && k.GetField(fieldName).ToString() != "null");
	}
	
	public static bool HasFieldAndNotNull(JSONObject k, string fieldName, out JSONObject fieldValue){
		if(k != null && k.HasField(fieldName) && k.GetField(fieldName) != null && k.GetField(fieldName).ToString() != "null"){
			fieldValue = k.GetField(fieldName);
			return true;
		} else {
			fieldValue = null;
			return false;
	...
	public static bool NotNull(JSONObject k){
		return (k != null && k.ToString() != "null" && k.str != "Null");

	}
	public static JSONObject ListToJSONObject(List<JSONObject> l){
		JSONObject k = new JSONObject(JSONObject.Type.ARRAY);
